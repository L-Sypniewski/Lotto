...
#tempdate = datetime.datetime(month=7,day=21,year=2017)
#DownloadData.SaveDrawToXML( r"F:\filenameTEST.xml", tempdate, True)
...
print(number_of_days_to_process) # result[1][0]['DrawDate']
